...
_Etter en kort beskrivelse av oppgaven skal det her være beskrevet hvordan PR'en er testet lokalt med tilhørende relevant dokumentasjon (skjermbilder, linker til Dev-miljø, osv.). Se [test-sjekklisten](../CONTRIBUTING.md#test-checklist) for hvordan testing skal gjøres._
