...
export const pluginRiScTranslationRef = createTranslationRef({
  ...
  messages: {
    ...
    rosStatus: {
      ...
      published: 'Risk scorecard is published',
      notPublished: 'This risk scorecard has not been published',
    ...
    no: () =>
      Promise.resolve({
        default: {
          ...
          'rosStatus.statusBadge.published': 'Denne ROSen er publisert',
          'rosStatus.lastPublished': 'Siste publisering',
          'rosStatus.notPublished': 'Denne ROSen har ikke blitt publisert',
